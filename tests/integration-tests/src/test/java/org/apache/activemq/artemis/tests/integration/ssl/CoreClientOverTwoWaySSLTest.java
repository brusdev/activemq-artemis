...
public class CoreClientOverTwoWaySSLTest extends ActiveMQTestBase {
    ...
    * keytool -export -keystore client-keystore.jks -file activemq-jks.cer -storepass securepass
    * keytool -import -keystore client-ca-truststore.jks -file activemq-jks.cer -storepass securepass -keypass securepass -noprompt
    *
    * keytool -genkey -keystore verified-client-keystore.jks -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Client, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg RSA -ext san=ip:127.0.0.1
    * keytool -export -keystore verified-client-keystore.jks -file activemq-jks.cer -storepass securepass
    * keytool -import -keystore verified-client-ca-truststore.jks -file activemq-jks.cer -storepass securepass -keypass securepass -noprompt
    *
    * Commands to create the JCEKS artifacts:
    * keytool -genkey -keystore client-side-keystore.jceks -storetype JCEKS -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Client, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg RSA
    * keytool -export -keystore client-side-keystore.jceks -file activemq-jceks.cer -storetype jceks -storepass securepass
    * keytool -import -keystore server-side-truststore.jceks -storetype JCEKS -file activemq-jceks.cer -storepass securepass -keypass securepass -noprompt
    *
    * keytool -genkey -keystore verified-client-side-keystore.jceks -storetype JCEKS -storepass securepass -keypass securepass -dname "CN=localhost, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg RSA -ext san=ip:127.0.0.1
    * keytool -export -keystore verified-client-side-keystore.jceks -file activemq-jceks.cer -storetype jceks -storepass securepass
    * keytool -import -keystore verified-server-side-truststore.jceks -storetype JCEKS -file activemq-jceks.cer -storepass securepass -keypass securepass -noprompt
    *
    * Commands to create the PKCS12 artifacts:
    * keytool -genkey -keystore client-side-keystore.p12 -storetype PKCS12 -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Client, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg RSA
    * keytool -export -keystore client-side-keystore.p12 -file activemq-p12.cer -storetype PKCS12 -storepass securepass
    * keytool -import -keystore server-side-truststore.p12 -storetype PKCS12 -file activemq-p12.cer -storepass securepass -keypass securepass -noprompt
    *
    * keytool -genkey -keystore verified-client-side-keystore.p12 -storetype PKCS12 -storepass securepass -keypass securepass -dname "CN=localhost, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg RSA -ext san=ip:127.0.0.1
    * keytool -export -keystore verified-client-side-keystore.p12 -file activemq-p12.cer -storetype PKCS12 -storepass securepass
    * keytool -import -keystore verified-server-side-truststore.p12 -storetype PKCS12 -file activemq-p12.cer -storepass securepass -keypass securepass -noprompt
    *
    ...
    * keytool -genkey -keystore client-keystore.jks -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Client, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC -sigalg SHA256withECDSA
    * keytool -export -keystore client-keystore.jks -file activemq-jks.cer -storepass securepass
    * keytool -import -keystore client-ca-truststore.jks -file activemq-jks.cer -storepass securepass -keypass securepass -noprompt
    *
    * keytool -genkey -keystore server-keystore.jks -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Server, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC -sigalg SHA256withECDSA
    ...
    *
    * keytool -genkey -keystore verified-client-keystore.jks -storepass securepass -keypass securepass -dname "CN=localhost, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC -sigalg SHA256withECDSA -ext san=ip:127.0.0.1
    * keytool -export -keystore verified-client-keystore.jks -file activemq-jks.cer -storepass securepass
    * keytool -import -keystore verified-client-ca-truststore.jks -file activemq-jks.cer -storepass securepass -keypass securepass -noprompt
    *
    * Commands to create the OpenSSL JCEKS artifacts:
    * keytool -genkey -keystore openssl-client-side-keystore.jceks -storetype JCEKS -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Client, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC  -sigalg SHA256withECDSA
    * keytool -export -keystore openssl-client-side-keystore.jceks -file activemq-jceks.cer -storetype jceks -storepass securepass
    * keytool -import -keystore openssl-server-side-truststore.jceks -storetype JCEKS -file activemq-jceks.cer -storepass securepass -keypass securepass -noprompt
    *
    * keytool -genkey -keystore openssl-server-side-keystore.jceks -storetype JCEKS -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Server, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC  -sigalg SHA256withECDSA
    * keytool -export -keystore openssl-server-side-keystore.jceks -file activemq-jceks.cer -storetype jceks -storepass securepass
    * keytool -import -keystore openssl-client-side-truststore.jceks -storetype JCEKS -file activemq-jceks.cer -storepass securepass -keypass securepass -noprompt
    *
    * keytool -genkey -keystore verified-openssl-client-side-keystore.jceks -storetype JCEKS -storepass securepass -keypass securepass -dname "CN=localhost, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC -sigalg SHA256withECDSA -ext san=ip:127.0.0.1
    * keytool -export -keystore verified-openssl-client-side-keystore.jceks -file activemq-jceks.cer -storetype jceks -storepass securepass
    * keytool -import -keystore verified-openssl-server-side-truststore.jceks -storetype JCEKS -file activemq-jceks.cer -storepass securepass -keypass securepass -noprompt
    *
    * Commands to create the OpenSSL PKCS12 artifacts:
    * keytool -genkey -keystore openssl-client-side-keystore.p12 -storetype PKCS12 -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Client, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC  -sigalg SHA256withECDSA
    * keytool -export -keystore openssl-client-side-keystore.p12 -file activemq-p12.cer -storetype PKCS12 -storepass securepass
    * keytool -import -keystore openssl-server-side-truststore.p12 -storetype PKCS12 -file activemq-p12.cer -storepass securepass -keypass securepass -noprompt
    *
    * keytool -genkey -keystore openssl-server-side-keystore.p12 -storetype PKCS12 -storepass securepass -keypass securepass -dname "CN=ActiveMQ Artemis Server, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC  -sigalg SHA256withECDSA
    * keytool -export -keystore openssl-server-side-keystore.p12 -file activemq-p12.cer -storetype PKCS12 -storepass securepass
    * keytool -import -keystore openssl-client-side-truststore.p12 -storetype PKCS12 -file activemq-p12.cer -storepass securepass -keypass securepass -noprompt
    *
    * keytool -genkey -keystore verified-openssl-client-side-keystore.p12 -storetype PKCS12 -storepass securepass -keypass securepass -dname "CN=localhost, OU=Artemis, O=ActiveMQ, L=AMQ, S=AMQ, C=AMQ" -keyalg EC -sigalg SHA256withECDSA -ext san=ip:127.0.0.1
    * keytool -export -keystore verified-openssl-client-side-keystore.p12 -file activemq-p12.cer -storetype PKCS12 -storepass securepass
    * keytool -import -keystore verified-openssl-server-side-truststore.p12 -storetype PKCS12 -file activemq-p12.cer -storepass securepass -keypass securepass -noprompt
    */
