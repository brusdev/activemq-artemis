...
public abstract class AbstractProtocolManager<P, I extends BaseInterceptor<P>, C extends RemotingConnection, R extends BrokerBalancerHandler> implements ProtocolManager<I, R> {
