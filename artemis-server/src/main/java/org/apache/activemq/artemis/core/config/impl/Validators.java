...
public final class Validators {
   ...
   public static final Validator CONNECTION_KEY = new Validator() {
      @Override
      public void validate(final String name, final Object value) {
         String val = (String) value;
         if (val == null || !EnumSet.allOf(ConnectionKey.class).contains(ConnectionKey.valueOf(val))) {
            throw ActiveMQMessageBundle.BUNDLE.invalidConnectionKey(val);
         }
      }
   };
}
