...
public class BrokerBalancer implements ActiveMQComponent {
   ...
   public BrokerBalancer(final String name, final TargetKey targetKey, final String localFilter, final Target localTarget, final Pool pool, final Policy policy, final int cacheTimeout) {
      this.name = name;
