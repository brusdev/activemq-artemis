...
public class OpenWireProtocolManager  extends AbstractProtocolManager<Command, OpenWireInterceptor, OpenWireConnection, OpenWireBrokerBalancerHandler> implements ClusterTopologyListener {
   ...
   private final OpenWireBrokerBalancerHandler redirectHandler;
   ...
   public OpenWireProtocolManager(OpenWireProtocolManagerFactory factory, ActiveMQServer server,
      ...
      redirectHandler = new OpenWireBrokerBalancerHandler(server, this);
   }
   ...
   @Override
   public OpenWireBrokerBalancerHandler getBrokerBalancerHandler() {
