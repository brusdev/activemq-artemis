...
import org.apache.activemq.artemis.protocol.amqp.proton.AMQPBrokerBalancerHandler;
 ...
 */
public class ProtonProtocolManager extends AbstractProtocolManager<AMQPMessage, AmqpInterceptor, ActiveMQProtonRemotingConnection, AMQPBrokerBalancerHandler> implements NotificationListener {
   ...
   private final AMQPBrokerBalancerHandler brokerBalancerHandler;
   ...
   * */
   ...
   public ProtonProtocolManager(ProtonProtocolManagerFactory factory, ActiveMQServer server, List<BaseInterceptor> incomingInterceptors, List<BaseInterceptor> outgoingInterceptors) {
      ...
      brokerBalancerHandler = new AMQPBrokerBalancerHandler(server);
   }
   ...
   @Override
   public AMQPBrokerBalancerHandler getBrokerBalancerHandler() {
      return brokerBalancerHandler;
   }
